module rose;
  ...
  //property includes a and $rose(b) using overlapped implication operator
  property p;
    // Property holds true when the a aseerted and at the same clock edge b go 0 or unknown to high     
