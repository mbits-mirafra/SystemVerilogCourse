module stable;  
  ...
  //property includes a and $stable(b) using overlapped implication operator
  property p;
    // Property holds true when the a aseerted and at the same clock edge b value be stable
    // same as previous clock
