module fell;  
  ...
  //property includes a and $fell(b) using overlapped implication operator
  property p;
    // Property holds true when the a aseerted and at the same clock edge b go 1 or unknown to low     
