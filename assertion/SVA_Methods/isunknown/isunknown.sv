module isunknown;  
  ...
  //property includes a and $isunknown(b) using overlapped implication operator
  property p;
    // Property holds true when the a aseerted and same clock any bit of b is X or Z     
