module countones;  
  ...
  //property includes a and $countones(b)==1 using overlapped implication operator
  property p;
    // Property holds true when the a aseerted and same clock number of ones in b is 1
